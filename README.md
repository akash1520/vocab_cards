...
Deploy to free tiers with **Neon** (Postgres) + **Render** (API) + **Vercel** (frontend).

See **[DEPLOY.md](DEPLOY.md)** for the full step-by-step guide, environment variables, troubleshooting, and redeploy notes.

**Note:** Fill with AI (Ollama) only works locally.
